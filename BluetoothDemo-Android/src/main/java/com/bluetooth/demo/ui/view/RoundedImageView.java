package com.bluetooth.demo.ui.view;
...
public class RoundedImageView extends ImageView {
	...
	public static final int[] RoundedImageView = { 0x0101011d, 0x7f010132, 0x7f010133, 0x7f010134, 0x7f010135, 0x7f010136 };
	...
	public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, RoundedImageView, defStyle, 0);

		int index = a.getInt(RoundedImageView_android_scaleType, -1);
		if (index >= 0) {
		...
		cornerRadius = a.getDimensionPixelSize(RoundedImageView_corner_radius, -1);
		borderWidth = a.getDimensionPixelSize(RoundedImageView_border_width, -1);
		...
		borderColor = a.getColorStateList(RoundedImageView_border_color);
		if (borderColor == null) {
			borderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
		}

		mutateBackground = a.getBoolean(RoundedImageView_mutate_background, false);
		isOval = a.getBoolean(RoundedImageView_oval, false);
